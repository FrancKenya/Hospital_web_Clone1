...
# Create service data
services_data = [
    {'name': 'General Consultation', 'description': 'Consultation with a \
        general practitioner'},
    {'name': 'Surgical Services', 'description': 'Full range of surgeries'},
    {'name': 'Maternal and Child Health', 'description': 'Services for \
        mothers and children'},
    {'name': 'Oncology', 'description': 'Cancer diagnosis and treatment'},
    {'name': 'Psychiatry and Mental Health', 'description': 'Mental health \
        consultations and treatments'},
    {'name': 'Laboratory Services', 'description': 'Blood tests, cultures, \
        etc.'},
    {'name': 'Radiology Services', 'description': 'X-rays, MRI, CT scans, \
        Ultrasounds'},
    {'name': 'Pathology Services', 'description': 'Lab analysis of tissue \
        samples'},
    {'name': 'Pharmacy Services', 'description': 'Pharmaceuticals and \
        medications'},
    {'name': 'Dialysis Unit', 'description': 'Kidney-related \
        treatments'},
    {'name': 'Dental and Eye Care Services', 'description': 'Dental and \
        eye health services'},
...
with app.app_context():
    ...
    # associate services with branches
